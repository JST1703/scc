...
Given is a 3x4 rectangle where each square has a digit 0 or 1.
...
*/
function SquareExecise1({ onWorong, onCorrect }) {
  /* 
  ...
  */
  ...
  const [data] = useState(() => {
    ...
    temp2.push(binaryCheckSymbol1([temp1[0], temp1[3]]));
    temp2.push(binaryCheckSymbol1([temp1[1], temp1[4]]));
    temp2.push(binaryCheckSymbol1([temp1[2], temp1[5]]));
